...
int historyBarokurve[] = {950,950,960,960,970,970,980,980,990,990,1000,1000,1010,1010,1020,1020,1030,1030,1040,1040,1050,1050,1060,1060}; //950 bis 1060
...
currentMinute = Bargraph.minute();
    ...
    { //means currentMinute = 0 and lastMinute = 59
      ...
      addHistoryHumAussen(Hum_Aussen);
      addHistoryValueBaro(LuftdruckWGT);
      addHistoryBarokurve(LuftdruckWGT);
       }  
...
void initLCD() {
 ...
 myGLCD.print(":", 520, 455, 0);
  ...
  myGLCD.setBackColor(TUERKIS);   myGLCD.setColor(WHITE);  myGLCD.print("BARGRAPH",x21+21,y21+10);  
  myGLCD.setColor(TUERKIS); button(x31,y31,x32,y32);    
  myGLCD.setBackColor(TUERKIS);   myGLCD.setColor(WHITE);  myGLCD.print("KURVENGRAPH",x31+10,y31+10); 
...
void addHistoryHumAussen(int value){
 ...
 void addHistoryBarokurve(int value){

  // shift left
  for (int i = 1; i<24; i++){
    historyBarokurve[i-1] = historyBarokurve[i];
  }
  historyBarokurve[23] = value;
